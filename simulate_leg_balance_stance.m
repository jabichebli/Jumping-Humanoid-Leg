...
% -------------------------------------------------------------------------
    ...
    v_takeoff = sqrt(2*params.g*0.03) ;


    % Trajectory Parameters
    params.y_stand   = 0.2;
    params.y_squat   = 0.06;
    params.y_takeoff = 0.5;
    params.T_hold    = 2.0;
    params.T_squat   = 0.6;
    params.T_push    = 0.3;
    ...
    t = t(1:takeoff_idx(end), :) ;
    X_sol = X_sol(1:takeoff_idx(end), :) ;
    u_sol = u_sol(1:takeoff_idx(end), :) ;
    lambda_sol = lambda_sol(1:takeoff_idx(end), :) ;
    ...
    [t_flight, X_flight] = ode45(@(t,x) dynamics_flight(t,x,params), tspan, x0);
    disp(length(t))
