function simulate_leg_jumping()
    ...
    params.m1 = 0.02;   params.m2 = 0.02;   params.m3 = 0.3;  % mass of leg ~1240*0.000047123 = 0.06; mass of one servo is 0.0134kg
    ...
    params.y_stand   = 0.2;
    params.y_squat   = 0.08;
    params.y_takeoff = 0.6;    % Takeoff height to produce enough y-velocity (actual takeoff height: ~0.258m)
    params.T_hold    = 2.0;
    params.T_squat   = 1.0;
    params.T_push    = 0.6;
    ...
    params.flight_u_max = [0.2; 0.2];  % N*m saturation
