function [dx, u, lambda] = leg_push_ode(~, x, params, F_hip)
% -------------------------------------------------------------------------
% leg_push_ode.m
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
    ...
    % Ensure Force applied to hip is considered
    if nargin < 4
        F_hip = [0; 0];
    end
    ...
    g = params.g; pCOMy_d = params.pCOMy_d;
    ...
    % -------- Create the external force vector ----------
    F_gen = [F_hip(1); F_hip(2); 0; 0; 0];
